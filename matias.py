...
def ver_ventas():
    if not ventas:
        ...
        for i in range(len(ventas)):
            ...
            print(f"Email: {cliente['email'] if cliente else 'Cliente no encontrado'}")
    ...
    while True:
        try:
            ...
            if 0 <= indice < len(clientes):
                ...
                ventas_cliente = [v for v in ventas if v.get('cuit_cliente') == cliente['cuit'] and v['estado'] == 'Activa']
